...
public class ShippingCosts {
    ...
    public static void main(String[] args) {
        ...
        double itemWeight = Double.parseDouble(JOptionPane.showInputDialog("How much doe sit weigh?"));
        int milesShipped = Integer.parseInt(JOptionPane.showInputDialog("How many miles did they drive?"));
        double shippingRate;
        double cost;
